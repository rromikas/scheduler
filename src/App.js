...
const daysInOrder = days.map((_, i) => days[(currentDay + i) % 7]);
...
const WeekScheduler = () => {
  ...
  const [ranges, setRanges] = useState(new Array(7).fill([]));
  ...
  return (
    <div className="w-100 vh-100 d-flex flex-center" style={{ fontSize: "14px" }}>
      <div className="p-5" style={{ background: "rgb(255, 249, 241)", overflowX: "auto" }}>
        <div
        ...
        <div className="d-flex" style={{ maxWidth: "1000px" }}>
          ...
          <div
            ...
            onMouseMove={(e) => {
              ...
              if (e.currentTarget.offsetWidth - x < 100 && dragging) {
